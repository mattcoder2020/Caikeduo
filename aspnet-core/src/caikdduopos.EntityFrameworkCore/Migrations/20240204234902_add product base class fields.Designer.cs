...
namespace caikdduopos.Migrations
{
    ...
    [Migration("20240204234902_add product base class fields")]
    partial class addproductbaseclassfields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("caikdduopos.AggregateRoots.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("caikdduopos.Entity.Cashier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("caikdduopos.Entity.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("caikdduopos.Entity.MerchandiseSales", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("MerchandiseSales");
                });

            modelBuilder.Entity("caikdduopos.Entity.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("caikdduopos.Entity.SalesRep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("caikdduopos.Entity.SalesType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("caikdduopos.Entity.MerchandiseSales", b =>
                {
                    b.HasOne("caikdduopos.Entity.Cashier", "Cashier")
                        .WithMany()
            ...
            modelBuilder.Entity("caikdduopos.Entity.Sales", b =>
                {
                    b.HasOne("caikdduopos.Entity.Member", "Member")
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("caikdduopos.Entity.PaymentMethod", "PaymentMethod")
                        .WithMany()
                        .HasForeignKey("PaymentMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("caikdduopos.Entity.SalesType", "SalesType")
                        .WithMany()
