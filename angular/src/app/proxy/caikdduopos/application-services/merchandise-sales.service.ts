...
import type { CreateMerchandiseDto, MerchandiseSalesDto } from '../dto/models';
...
export class MerchandiseSalesService {
  ...
  create = (input: CreateMerchandiseDto, config?: Partial<Rest.Config>) =>
  ...
  update = (id: string, input: CreateMerchandiseDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, MerchandiseSalesDto>({
      method: 'PUT',
      url: `/api/app/merchandise-sales/${id}`,
      body: input,
